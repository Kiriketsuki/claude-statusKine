...
This project is indexed by GitNexus as **statusline** (10 symbols, 0 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
